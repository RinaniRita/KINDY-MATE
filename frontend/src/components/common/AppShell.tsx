...
export function AppShell({ children, nav, subtitle, title, tone = "public", childId }: AppShellProps) {
  ...
  return (
    <main className={`min-h-screen pb-16 selection:bg-[#dff6ee] selection:text-slate-800 ${isChildTone ? "theme-child bg-gradient-to-b from-[#fff7ea] via-[#eef8ff] to-[#ecfaf3]" : tone === "parent" ? "theme-parent bg-[#fffdf7]" : "theme-public bg-[#fffdf7]"}`}>
      {!isChildTone ? (
